    ...
    a.widget("ui.chatbox", {
        ...
        "_create": function() {
            var b = this,
                ...
                g = ((b.uiChatboxTitle = a("<span></span>")).html(d).appendTo(f), (b.uiChatboxTitlebarClose = a('<a href="#" rel="tooltip" data-placement="top" data-original-title="Ocultar"></a>')).addClass("ui-chatbox-icon ").attr("role", "button").hover(function() {
                ...
                h = (a("<i></i>").addClass("fa fa-times").appendTo(g), (b.uiChatboxTitlebarMinimize = a('<a href="#" rel="tooltip" data-placement="top" data-original-title="Minimizar"></a>')).addClass("ui-chatbox-icon").attr("role", "button").hover(function() {
                ...
                k = (b.uiChatboxInputBox = a("<textarea></textarea>")).addClass("ui-widget-content ui-chatbox-input-box ").appendTo(j).keydown(function(c) {
                    if (c.keyCode && c.keyCode == a.ui.keyCode.ENTER) return msg = a.trim(a(this).val()), msg.length > 0 && b.options.messageSent(b.options.id, b.options.user, msg), a(this).val(""), !1
                }).focusin(function() {
...
function(a) {
    a.fn.emoticonize = function(b) {
        ...
        return this.each(function() {
            a(this).find("span.css-emoticon").each(function() {
                var b = a(this);
