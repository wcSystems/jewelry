var chatboxManager = function() {
    var a = function(a) {
        ...
        f = function(a, b, c) {
			enviamensaje(a,b,c);
            $("#chatlog").doesExist() && $("#chatlog").append("You said to <b>" + b.first_name + " " + b.last_name + ":</b> " + c + "<br/>").effect("highlight", {}, 500), $("#" + a).chatbox("option", "boxManager").addMsg("Yo", c)
        };
    return {
        "init": a,
        "addBox": e,
...
$("a[data-chat-id]:not(.offline)").click(function(a, b) {
	historial($(this).attr("data-chat-id"));
    var c = $(this),
