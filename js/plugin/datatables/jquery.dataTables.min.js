 ...
 */! function(a) {
    ...
    function e(b) {
        ...
        a.each(b, function(a, h) {
            c = a.match(/^([^A-Z]+?)([A-Z])/), c && -1 !== f.indexOf(c[1] + " ") && (d = a.replace(c[0], c[2].toLowerCase()), g[d] = a, "o" === c[1] && e(b[a]))
        }), b._hungarianMap = g
    }
    ...
    function g(a) {
        var b = Ua.defaults.oLanguage,
            c = a.sZeroRecords;
        !a.sEmptyTable && c && "No data available in table" === b.sEmptyTable && Ja(a, a, "sZeroRecords", "sEmptyTable"), !a.sLoadingRecords && c && "Loading..." === b.sLoadingRecords && Ja(a, a, "sZeroRecords", "sLoadingRecords"), a.sInfoThousands && (a.sThousands = a.sInfoThousands);
        var d = a.sDecimal;
        d && Sa(d)
    }

    function h(a) {
        qb(a, "ordering", "bSort"), qb(a, "orderMulti", "bSortMulti"), qb(a, "orderClasses", "bSortClasses"), qb(a, "orderCellsTop", "bSortCellsTop"), qb(a, "order", "aaSorting"), qb(a, "orderFixed", "aaSortingFixed"), qb(a, "paging", "bPaginate"), qb(a, "pagingType", "sPaginationType"), qb(a, "pageLength", "iDisplayLength"), qb(a, "searching", "bFilter"), "boolean" == typeof a.sScrollX && (a.sScrollX = a.sScrollX ? "100%" : ""), "boolean" == typeof a.scrollX && (a.scrollX = a.scrollX ? "100%" : "");
        var b = a.aoSearchCols;
        if (b)
            for (var c = 0, d = b.length; d > c; c++) b[c] && f(Ua.models.oSearch, b[c])
    }

    function i(b) {
        qb(b, "orderable", "bSortable"), qb(b, "orderData", "aDataSort"), qb(b, "orderSequence", "asSorting"), qb(b, "orderDataType", "sortDataType");
        var c = b.aDataSort;
    ...
    function j(b) {
        if (!Ua.__browser) {
            ...
            var d = a("<div/>").css({
                ...
                e = d.children(),
                f = e.children();
            c.barWidth = e[0].offsetWidth - e[0].clientWidth, c.bScrollOversize = 100 === f[0].offsetWidth && 100 !== e[0].clientWidth, c.bScrollbarLeft = 1 !== Math.round(f.offset().left), c.bBounding = d[0].getBoundingClientRect().width ? !0 : !1, d.remove()
        }
        a.extend(b.oBrowser, Ua.__browser), b.oScroll.iBarWidth = Ua.__browser.barWidth
    }
    ...
    function l(b, d) {
        ...
        h[f] = a.extend({}, Ua.models.oSearch, h[f]), m(b, f, a(d).data())
    }
    ...
    function n(a) {
        ...
        var e = a.oScroll;
        ("" !== e.sY || "" !== e.sX) && qa(a), Na(a, null, "column-sizing", [a])
    }
        ...
        if (c)
            for (g = c.length - 1; g >= 0; g--) {
                ...
                for (a.isArray(p) || (p = [p]), i = 0, j = p.length; j > i; i++)
                    ...
                    for (k = 0, m = o.length; m > k; k++)("_all" == p[i] || a(o[k].nTh).hasClass(p[i])) && f(k, n)
            }
        if (e)
    ...
    function y(a, b, c, e) {
        ...
        if (j === d) return a.iDrawError != f && null === i && (Ia(a, 0, "Requested unknown parameter " + ("function" == typeof g.mData ? "{function}" : "'" + g.mData + "'") + " for row " + b + ", column " + c, 4), a.iDrawError = f), i;
                ...
                for (var k = A(f), l = 0, m = k.length; m > l; l++) {
                    if (g = k[l].match(rb), h = k[l].match(sb), g) {
                        if (k[l] = k[l].replace(rb, ""), "" !== k[l] && (b = b[k[l]]), i = [], k.splice(0, l + 1), j = k.join("."), a.isArray(b))
                            for (var n = 0, o = b.length; o > n; n++) i.push(e(b[n], c, j));
                        var p = g[0].substring(1, g[0].length - 1);
                        b = "" === p ? i : i.join(p);
                        break
                    }
                    if (h) k[l] = k[l].replace(sb, ""), b = b[k[l]]();
                    else {
            ...
            for (var g, h, i, j, k, l = A(f), m = l[l.length - 1], n = 0, o = l.length - 1; o > n; n++) {
                if (h = l[n].match(rb), i = l[n].match(sb), h) {
                    if (l[n] = l[n].replace(rb, ""), b[l[n]] = [], g = l.slice(), g.splice(0, n + 1), k = g.join("."), a.isArray(e))
                        for (var p = 0, q = e.length; q > p; p++) j = {}, c(j, e[p], k), b[l[n]].push(j);
                    else b[l[n]] = e;
                    return
                }
                i && (l[n] = l[n].replace(sb, ""), b = b[l[n]](e)), (null === b[l[n]] || b[l[n]] === d) && (b[l[n]] = {}), b = b[l[n]]
            }
    ...
    function F(a, b, c) {
        for (var e = -1, f = 0, g = a.length; g > f; f++) a[f] == b ? e = f : a[f] > b && a[f]--; - 1 != e && c === d && a.splice(e, 1)
    }
    ...
    function I(b, d, e, f) {
        var g, h, i, j, k, l = b.aoData[d],
            ...
            n = [];
        if (null === l.nTr) {
            for (g = e || c.createElement("tr"), l.nTr = g, l.anCells = n, g._DT_RowIndex = d, J(b, l), j = 0, k = b.aoColumns.length; k > j; j++) i = b.aoColumns[j], h = e ? f[j] : c.createElement(i.sCellType), h._DT_CellIndex = {
                "row": d,
                "column": j
    ...
    function J(b, c) {
        ...
        if (d) {
            ...
            if (f && (d.id = f), e.DT_RowClass) {
                ...
                c.__rowc = c.__rowc ? pb(c.__rowc.concat(g)) : g, a(d).removeClass(c.__rowc.join(" ")).addClass(e.DT_RowClass)
            }
    ...
    function K(b) {
        var c, d, e, f, g, h = b.nTHead,
            ...
            k = b.oClasses,
            l = b.aoColumns;
        for (j && (f = a("<tr/>").appendTo(h)), c = 0, d = l.length; d > c; c++) g = l[c], e = a(g.nTh).addClass(g.sClass), j && e.appendTo(f), b.oFeatures.bSort && (e.addClass(g.sSortingClass), g.bSortable !== !1 && (e.attr("tabindex", b.iTabIndex).attr("aria-controls", b.sTableId), Ca(b, g.nTh, c))), g.sTitle != e[0].innerHTML && e.html(g.sTitle), Pa(b, "header")(b, e, g, k);
        if (j && P(b.aoHeader, h), a(h).find(">tr").attr("role", "row"), a(h).find(">tr>th, >tr>td").addClass(k.sHeaderTH), a(i).find(">tr>th, >tr>td").addClass(k.sFooterTH), null !== i) {
            var m = b.aoFooter[0];
            for (c = 0, d = m.length; d > c; c++) g = l[c], g.nTf = m[c].cell, g.sClass && a(g.nTf).addClass(g.sClass)
        }
    }
    ...
    function M(b) {
        ...
        if (-1 !== a.inArray(!1, c)) return void oa(b, !1);
        var e = [],
            f = 0,
            g = b.asStripeClasses,
            h = g.length,
            ...
            k = "ssp" == Qa(b),
            l = b.aiDisplay;
        b.bDrawing = !0, j !== d && -1 !== j && (b._iDisplayStart = k ? j : j >= b.fnRecordsDisplay() ? 0 : j, b.iInitDisplayStart = -1);
        var m = b._iDisplayStart,
            n = b.fnDisplayEnd();
        if (b.bDeferLoading) b.bDeferLoading = !1, b.iDraw++, oa(b, !1);
        else if (k) {
        ...
        if (0 !== l.length)
            for (var o = k ? 0 : m, p = k ? b.aoData.length : n, r = o; p > r; r++) {
                ...
                Na(b, "aoRowCallback", null, [u, t._aData, f, r]), e.push(u), f++
            } else {
                var w = i.sZeroRecords;
                1 == b.iDraw && "ajax" == Qa(b) ? w = i.sLoadingRecords : i.sEmptyTable && 0 === b.fnRecordsTotal() && (w = i.sEmptyTable), e[0] = a("<tr/>", {
                    "class": h ? g[0] : ""
                }).append(a("<td />", {
                    "valign": "top",
                    "colSpan": q(b),
        ...
        Na(b, "aoHeaderCallback", "header", [a(b.nTHead).children("tr")[0], D(b), m, n, l]), Na(b, "aoFooterCallback", "footer", [a(b.nTFoot).children("tr")[0], D(b), m, n, l]);
        var x = a(b.nTBody);
        x.children().detach(), x.append(a(e)), Na(b, "aoDrawCallback", "draw", [b]), b.bSorted = !1, b.bFiltered = !1, b.bDrawing = !1
    }
    ...
    function N(a, b) {
        var c = a.oFeatures,
            d = c.bSort,
            e = c.bFilter;
        d && za(a), e ? X(a, a.oPreviousSearch) : a.aiDisplay = a.aiDisplayMaster.slice(), b !== !0 && (a._iDisplayStart = 0), a._drawHold = b, M(a), a._drawHold = !1
    }
    ...
    function O(b) {
        ...
        for (var h, i, j, k, l, m, n = b.sDom.split(""), o = 0; o < n.length; o++) {
            ...
            else if ("l" == i && f.bPaginate && f.bLengthChange) h = ka(b);
            else if ("f" == i && f.bFilter) h = W(b);
            else if ("r" == i && f.bProcessing) h = na(b);
            else if ("t" == i) h = pa(b);
            else if ("i" == i && f.bInfo) h = ea(b);
            else if ("p" == i && f.bPaginate) h = la(b);
    ...
    function P(b, c) {
        ...
        for (b.splice(0, b.length), f = 0, i = o.length; i > f; f++) b.push([]);
    ...
    function R(b, c, d) {
        ...
        var l = {
            ...
            "success": function(a) {
                ...
                c && Ia(b, 0, c), b.json = a, j(a)
            },
            "dataType": "json",
            "cache": !1,
            "type": b.sServerMethod,
            "error": function(c, d, e) {
                var f = Na(b, null, "xhr", [b, null, b.jqXHR]); - 1 === a.inArray(!0, f) && ("parsererror" == d ? Ia(b, 0, "Invalid JSON response", 1) : 4 === c.readyState && Ia(b, 0, "Ajax error", 7)), oa(b, !1)
            }
        };
        b.oAjaxData = c, Na(b, null, "preXhr", [b, c]), b.fnServerData ? b.fnServerData.call(i, b.sAjaxSource, a.map(c, function(a, b) {
            return {
                "name": b,
                "value": a
            }
    ...
    function T(b) {
        ...
        p("sEcho", b.iDraw), p("iColumns", h), p("sColumns", kb(g, "sName").join(",")), p("iDisplayStart", n), p("iDisplayLength", o);
        var q = {
            "draw": b.iDraw,
            "columns": [],
            "order": [],
        ...
        for (c = 0; h > c; c++) e = g[c], f = k[c], d = "function" == typeof e.mData ? "function" : e.mData, q.columns.push({
            "data": d,
            "name": e.sName,
    ...
    function X(a, b, c) {
        ...
        a.bFiltered = !0, Na(a, null, "search", [a])
    }
    ...
    function $(a, b, c, d, e, f) {
        var g, h, i, j = _(b, d, e, f),
            ...
            l = a.aiDisplayMaster;
        if (0 !== Ua.ext.search.length && (c = !0), h = ba(a), b.length <= 0) a.aiDisplay = l.slice();
        else
    ...
    function ba(a) {
        ...
        for (c = 0, e = a.aoData.length; e > c; c++)
            if (i = a.aoData[c], !i._aFilterData) {
                for (g = [], d = 0, f = j.length; f > d; d++) b = j[d], b.bSearchable ? (h = y(a, c, d, "filter"), k[b.sType] && (h = k[b.sType](h)), null === h && (h = ""), "string" != typeof h && h.toString && (h = h.toString())) : h = "", h.indexOf && -1 !== h.indexOf("&") && (tb.innerHTML = h, h = ub ? tb.textContent : tb.innerText), h.replace && (h = h.replace(/[\r\n]/g, "")), g.push(h);
    ...
    function fa(b) {
        ...
        if (0 !== c.length) {
            ...
            h !== g && (i += " " + d.sInfoFiltered), i += d.sInfoPostFix, i = ga(b, i);
    ...
    function ha(a) {
        ...
        for (O(a), K(a), L(a, a.aoHeader), L(a, a.aoFooter), oa(a, !0), g.bAutoWidth && sa(a), b = 0, c = f.length; c > b; b++) d = f[b], d.sWidth && (d.nTh.style.width = xa(d.sWidth));
        Na(a, null, "preInit", [a]), N(a);
        var i = Qa(a);
    ...
    function ia(a, b) {
        a._bInitComplete = !0, (b || a.oInit.aaData) && n(a), Na(a, null, "plugin-init", [a, b]), Na(a, "aoInitComplete", "init", [a, b])
    }

    function ja(a, b) {
        var c = parseInt(b, 10);
        a._iDisplayLength = c, Oa(a), Na(a, null, "length", [a, c])
    }
            ...
            "fn": function(a) {
                if (e) {
                    var b, c, g = a._iDisplayStart,
                        ...
                        m = k ? 1 : Math.ceil(j / i),
                        n = d(l, m);
                    for (b = 0, c = h.p.length; c > b; b++) Pa(a, "pageButton")(a, h.p[b], b, n, l, m)
                } else d.fnUpdate(a, f)
            },
            "sName": "pagination"
        })), g
    ...
    function ma(a, b, c) {
        ...
        return a._iDisplayStart = d, g && (Na(a, null, "page", [a]), c && M(a)), g
    }
    ...
    function oa(b, c) {
        b.oFeatures.bProcessing && a(b.aanFeatures.r).css("display", c ? "block" : "none"), Na(b, null, "processing", [b, c])
    }
    ...
    function qa(b) {
        ...
        b.scrollBarVis = S, F.children("thead, tfoot").remove(), I && (i = I.clone().prependTo(F), e = I.find("tr"), g = i.find("tr")), h = E.clone().prependTo(F), c = E.find("tr"), f = h.find("tr"), h.find("th, td").removeAttr("tabindex"), p || (A.width = "100%", t[0].style.width = "100%"), a.each(Q(b, h), function(a, c) {
            ...
            a.style.width = ""
        }, g), l = F.outerWidth(), "" === p ? (H.width = "100%", K && (F.find("tbody").height() > y.offsetHeight || "scroll" == z.css("overflow-y")) && (H.width = xa(F.outerWidth() - s)), l = F.outerWidth()) : "" !== q && (H.width = xa(q), l = F.outerWidth()), ra(R, f), ra(function(b) {
            O.push(b.innerHTML), M.push(xa(a(b).css("width")))
        }, f), ra(function(b, c) {
            -1 !== a.inArray(b, L) && (b.style.width = M[c])
        }, c), a(f).height(0), I && (ra(R, g), ra(function(b) {
            P.push(b.innerHTML), N.push(xa(a(b).css("width")))
        }, g), ra(function(a, b) {
            a.style.width = N[b]
        }, e), a(g).height(0)), ra(function(a, b) {
        ...
        }, g), F.outerWidth() < l ? (k = y.scrollHeight > y.offsetHeight || "scroll" == z.css("overflow-y") ? l + s : l, K && (y.scrollHeight > y.offsetHeight || "scroll" == z.css("overflow-y")) && (H.width = xa(k - s)), ("" === p || "" !== q) && Ia(b, 1, "Possible column misalignment", 6)) : k = "100%", A.width = xa(k), u.width = xa(k), I && (b.nScrollFoot.style.width = xa(k)), r || K && (A.height = xa(G.offsetHeight + s));
        var T = F.outerWidth();
        x[0].style.width = xa(T), w.width = xa(T);
        var U = F.height() > y.clientHeight || "scroll" == z.css("overflow-y"),
            V = "padding" + (J.bScrollbarLeft ? "Left" : "Right");
        w[V] = U ? s + "px" : "0px", I && (D[0].style.width = xa(T), C[0].style.width = xa(T), C[0].style[V] = U ? s + "px" : "0px"), F.children("colgroup").insertBefore(F.children("thead")), z.scroll(), !b.bSorted && !b.bFiltered || b._drawHold || (y.scrollTop = 0)
    }
    ...
    function sa(c) {
        var d, e, f, g = c.nTable,
            ...
            x = w.bScrollOversize,
            y = g.style.width;
        for (y && -1 !== y.indexOf("%") && (t = y), d = 0; d < p.length; d++) e = h[p[d]], null !== e.sWidth && (e.sWidth = ua(e.sWidthOrig, u), v = !0);
        if (x || !v && !k && !j && m == q(c) && m == s.length)
            for (d = 0; m > d; d++) {
                ...
                for (A.find("thead, tfoot").remove(), A.append(a(c.nTHead).clone()).append(a(c.nTFoot).clone()), A.find("tfoot th, tfoot td").css("width", ""), s = Q(c, A.find("thead")[0]), d = 0; d < p.length; d++) e = h[p[d]], s[d].style.width = null !== e.sWidthOrig && "" !== e.sWidthOrig ? xa(e.sWidthOrig) : "", e.sWidthOrig && k && a(s[d]).append(a("<div/>").css({
                    "width": e.sWidthOrig,
                    "margin": 0,
                    "padding": 0,
                    "border": 0,
                ...
                if (c.aoData.length)
                    for (d = 0; d < p.length; d++) f = p[d], e = h[f], a(va(c, f)).clone(!1).append(e.sContentPadding).appendTo(B);
                ...
                for (d = 0; d < p.length; d++) {
                    ...
                    D += G, h[p[d]].sWidth = xa(G - F)
                }
                g.style.width = xa(D), C.remove()
            }
    ...
    function wa(a, b) {
        for (var c, d = -1, e = -1, f = 0, g = a.aoData.length; g > f; f++) c = y(a, f, b, "display") + "", c = c.replace(vb, ""), c = c.replace(/&nbsp;/g, " "), c.length > d && (d = c.length, e = f);
        return e
    }
    ...
    function ya(b) {
        ...
        for (a.isArray(m) && p(m), n && m.pre && p(m.pre), p(b.aaSorting), n && m.post && p(m.post), c = 0; c < o.length; c++)
            for (j = o[c][0], g = l[j].aDataSort, e = 0, f = g.length; f > e; e++) h = g[e], i = l[h].sType || "string", o[c]._idx === d && (o[c]._idx = a.inArray(o[c][1], l[h].asSorting)), k.push({
                "src": j,
                "col": h,
                "dir": o[c][1],
                "index": o[c]._idx,
    ...
    function za(a) {
        var b, c, d, e, f, g = [],
            ...
            j = (a.aoColumns, 0),
            k = a.aiDisplayMaster;
        for (s(a), f = ya(a), b = 0, c = f.length; c > b; b++) e = f[b], e.formatter && j++, Ea(a, e.col);
    ...
    function Ba(b, c, e, f) {
        ...
        if ("number" == typeof i[0] && (i = b.aaSorting = [i]), e && b.oFeatures.bSortMulti) {
            var l = a.inArray(c, kb(i, "0")); - 1 !== l ? (g = k(i[l], !0), null === g && 1 === i.length && (g = 0), null === g ? i.splice(l, 1) : (i[l][1] = j[g], i[l]._idx = g)) : (i.push([c, j[0], 0]), i[i.length - 1]._idx = 0)
    ...
    function Ca(a, b, c, d) {
        ...
        La(b, {}, function(b) {
            e.bSortable !== !1 && (a.oFeatures.bProcessing ? (oa(a, !0), setTimeout(function() {
                Ba(a, c, b.shiftKey, d), "ssp" !== Qa(a) && oa(a, !1)
    ...
    function Da(b) {
        ...
        if (i.bSort && i.bSortClasses) {
            for (c = 0, d = f.length; d > c; c++) e = f[c].src, a(kb(b.aoData, "anCells", e)).removeClass(g + (2 > c ? c + 1 : 3));
            for (c = 0, d = h.length; d > c; c++) e = h[c].src, a(kb(b.aoData, "anCells", e)).addClass(g + (2 > c ? c + 1 : 3))
        }
        b.aLastSort = h
    }
    ...
    function Ea(a, b) {
        ...
        for (var f, g, h = Ua.ext.type.order[d.sType + "-pre"], i = 0, j = a.aoData.length; j > i; i++) f = a.aoData[i], f._aSortData || (f._aSortData = []), (!f._aSortData[b] || e) && (g = e ? c[i] : y(a, i, b, "sort"), f._aSortData[b] = h ? h(g) : g)
    }
    ...
    function Fa(b) {
        if (b.oFeatures.bStateSave && !b.bDestroying) {
            ...
            Na(b, "aoStateSaveParams", "stateSaveParams", [b, c]), b.oSavedState = c, b.fnStateSaveCallback.call(b.oInstance, b, c)
        }
    }
    ...
    function Ga(b, c) {
        ...
        if (b.oFeatures.bStateSave) {
            ...
            if (h && h.time) {
                var i = Na(b, "aoStateLoadParams", "stateLoadParams", [b, h]);
                if (-1 === a.inArray(!1, i)) {
                    ...
                    if (!(j > 0 && h.time < +new Date - 1e3 * j) && g.length === h.columns.length) {
                        for (b.oLoadedState = a.extend(!0, {}, h), h.start !== d && (b._iDisplayStart = h.start, b.iInitDisplayStart = h.start), h.length !== d && (b._iDisplayLength = h.length), h.order !== d && (b.aaSorting = [], a.each(h.order, function(a, c) {
                            ...
                            })), h.search !== d && a.extend(b.oPreviousSearch, da(h.search)), e = 0, f = h.columns.length; f > e; e++) {
                            var k = h.columns[e];
                            k.visible !== d && (g[e].bVisible = k.visible), k.search !== d && a.extend(b.aoPreSearchCols[e], da(k.search))
                        }
                        Na(b, "aoStateLoaded", "stateLoaded", [b, h])
                    }
                }
            }
        }
    ...
    function Ia(a, c, d, e) {
        if (d = "DataTables warning: " + (a ? "table id=" + a.sTableId + " - " : "") + d, e && (d += ". For more information about this error, please see http://datatables.net/tn/" + e), c) b.console && console.log && console.log(d);
            ...
            if (a && Na(a, null, "error", [a, e, d]), "alert" == g) alert(d);
            else {
    ...
    function Ra(a, b) {
        var c = [],
            d = Sb.numbers_length,
            e = Math.floor(d / 2);
        return d >= b ? c = mb(0, b) : e >= a ? (c = mb(0, d - 2), c.push("ellipsis"), c.push(b - 1)) : a >= b - 1 - e ? (c = mb(b - (d - 2), b), c.splice(0, 0, "ellipsis"), c.splice(0, 0, 0)) : (c = mb(a - e + 2, a + e - 1), c.push("ellipsis"), c.push(b - 1), c.splice(0, 0, "ellipsis"), c.splice(0, 0, 0)), c.DT_el = "span", c
    }
    ...
    function Sa(b) {
        a.each({
            ...
            Va.type.order[a + b + "-pre"] = c, a.match(/^html\-/) && (Va.type.search[a + b] = Va.type.search.html)
        })
    }
    ...
    var Ua, Va, Wa, Xa, Ya, Za = {},
        ...
        db = /[',$\xc2\xa3\xe2\u201a\xac\xc2\xa5%\u2009\u202F\u20BD\u20a9\u20BArfk]/gi,
        eb = function(a) {
            return a && a !== !0 && "-" !== a ? !1 : !0
        },
        fb = function(a) {
        ...
        gb = function(a, b) {
            return Za[b] || (Za[b] = new RegExp(aa(b), "g")), "string" == typeof a && "." !== b ? a.replace(/\./g, "").replace(Za[b], ".") : a
        },
        hb = function(a, b, c) {
        ...
        kb = function(a, b, c) {
            var e = [],
                ...
                g = a.length;
            if (c !== d)
                for (; g > f; f++) a[f] && a[f][b] && e.push(a[f][b][c]);
            else
        ...
        lb = function(a, b, c, e) {
            var f = [],
                ...
                h = b.length;
            if (e !== d)
                for (; h > g; g++) a[b[g]][c] && f.push(a[b[g]][c][e]);
            else
                for (; h > g; g++) f.push(a[b[g]][c]);
            return f
        },
        mb = function(a, b) {
            var c, e = [];
            b === d ? (b = 0, c = a) : (c = b, b = a);
            for (var f = b; c > f; f++) e.push(f);
            return e
        },
        nb = function(a) {
    ...
    Ua = function(b) {
        ...
        var c = this,
            e = b === d,
            k = this.length;
        e && (b = {}), this.oApi = this.internal = Va.internal;
        for (var n in Ua.ext.internal) n && (this[n] = Ta(n));
        return this.each(function() {
            var n, o = {},
                ...
                w = Ua.defaults,
                x = a(this);
            if ("table" != this.nodeName.toLowerCase()) return void Ia(null, 0, "Non-table node initialisation (" + this.nodeName + ")", 2);
            ...
            ]), Ja(D.oLanguage, p, "fnInfoCallback"), Ma(D, "aoDrawCallback", p.fnDrawCallback, "user"), Ma(D, "aoServerParams", p.fnServerParams, "user"), Ma(D, "aoStateSaveParams", p.fnStateSaveParams, "user"), Ma(D, "aoStateLoadParams", p.fnStateLoadParams, "user"), Ma(D, "aoStateLoaded", p.fnStateLoaded, "user"), Ma(D, "aoRowCallback", p.fnRowCallback, "user"), Ma(D, "aoRowCreatedCallback", p.fnCreatedRow, "user"), Ma(D, "aoHeaderCallback", p.fnHeaderCallback, "user"), Ma(D, "aoFooterCallback", p.fnFooterCallback, "user"), Ma(D, "aoInitComplete", p.fnInitComplete, "user"), Ma(D, "aoPreDrawCallback", p.fnPreDrawCallback, "user"), D.rowIdFn = B(p.rowId), j(D);
            var E = D.oClasses;
            ...
            a.extend(!0, G, p.oLanguage), "" !== G.sUrl && (a.ajax({
                ...
                "url": G.sUrl,
                "success": function(b) {
                    g(b), f(w.oLanguage, b), a.extend(!0, G, b), ha(D)
                },
                "error": function() {
                    ha(D)
                }
            ...
            var H = D.asStripeClasses,
                I = x.children("tbody").find("tr").eq(0); - 1 !== a.inArray(!0, a.map(H, function(a, b) {
                return I.hasClass(a)
            ...
            for (q = 0, n = J.length; n > q; q++) l(D, K ? K[q] : null);
            ...
            if (p.bStateSave && (N.bStateSave = !0, Ga(D, p), Ma(D, "aoDrawCallback", Fa, "state_save")), p.aaSorting === d) {
                var O = D.aaSorting;
                for (q = 0, n = O.length; n > q; q++) O[q][1] = D.aoColumns[q].asSorting[0]
            }
            Da(D), N.bSort && Ma(D, "aoDrawCallback", function() {
                if (D.bSorted) {
                    var b = ya(D),
                        c = {};
                    a.each(b, function(a, b) {
                        c[b.src] = b.dir
                    }), Na(D, null, "order", [D, b, c]), Aa(D)
                }
            ...
            D.aiDisplay = D.aiDisplayMaster.slice(), D.bInitialised = !0, s === !1 && ha(D)
        }), c = null, this
    };
    var wb = [],
        xb = Array.prototype,
        yb = function(b) {
            ...
            return b ? b.nTable && b.oApi ? [b] : b.nodeName && "table" === b.nodeName.toLowerCase() ? (c = a.inArray(b, f), -1 !== c ? [e[c]] : null) : b && "function" == typeof b.settings ? b.settings().toArray() : ("string" == typeof b ? d = a(b) : b instanceof a && (d = b), d ? d.map(function(b) {
                return c = a.inArray(this, f), -1 !== c ? e[c] : null
            }).toArray() : void 0) : []
        };
    Wa = function(b, c) {
        if (!(this instanceof Wa)) return new Wa(b, c);
        var d = [],
            e = function(a) {
                var b = yb(a);
                b && (d = d.concat(b))
        ...
        if (a.isArray(b))
            for (var f = 0, g = b.length; g > f; f++) e(b[f]);
        else e(b);
        this.context = pb(d), c && a.merge(this, c), this.selector = {
            "rows": null,
            "cols": null,
            "opts": null
        }, Wa.extend(this, this, wb)
    }, Ua.Api = Wa, a.extend(Wa.prototype, {
        "any": function() {
            return 0 !== this.count()
        },
        "concat": xb.concat,
        ...
        "iterator": function(a, b, c, e) {
            ...
            for ("string" == typeof a && (e = c, c = b, b = a, a = !1), g = 0, h = o.length; h > g; g++) {
                ...
                if ("table" === b) f = c.call(q, o[g], g), f !== d && n.push(f);
                    ...
                    for (l = this[g], "column-rows" === b && (k = Eb(o[g], p.opts)), i = 0, j = l.length; j > i; i++) m = l[i], f = "cell" === b ? c.call(q, o[g], m.row, m.column, g, i) : c.call(q, o[g], m, g, i, k), f !== d && n.push(f)
            }
            if (n.length || e) {
        ...
        if (d.length && c && (c instanceof Wa || c.__dt_wrapper)) {
            var e, f, g, h = function(a, b, c) {
                return function() {
                    ...
                    return Wa.extend(d, d, c.methodExt), d
                }
            };
            for (e = 0, f = d.length; f > e; e++) g = d[e], c[g.name] = "function" == typeof g.val ? h(b, g.val, g) : a.isPlainObject(g.val) ? {} : g.val, c[g.name].__dt_wrapper = !0, Wa.extend(b, c[g.name], g.propExt)
        }
    }, Wa.register = Xa = function(b, c) {
        if (a.isArray(b))
            for (var d = 0, e = b.length; e > d; d++) Wa.register(b[d], c);
        else {
        ...
        Wa.register(b, e), Wa.register(c, function() {
    ...
    var Bb = function(b, c, e, f, g) {
            ...
            for (c && "string" !== o && "function" !== o && c.length !== d || (c = [c]), j = 0, k = c.length; k > j; j++)
                for (i = c[j] && c[j].split ? c[j].split(",") : [c[j]], l = 0, m = i.length; m > l; l++) h = e("string" == typeof i[l] ? a.trim(i[l]) : i[l]), h && h.length && (n = n.concat(h));
            var p = Va.selector[b];
            if (p.length)
                for (j = 0, k = p.length; k > j; j++) n = p[j](f, g, n);
            return pb(n)
        },
        Cb = function(b) {
        ...
        Eb = function(b, c) {
            var d, e, f, g = [],
                ...
                k = c.order,
                l = c.page;
            if ("ssp" == Qa(b)) return "removed" === j ? [] : mb(0, i.length);
            if ("current" == l)
                for (d = b._iDisplayStart, e = b.fnDisplayEnd(); e > d; d++) g.push(h[d]);
                ...
                for (d = 0, e = b.aoData.length; e > d; d++) "none" == j ? g.push(d) : (f = a.inArray(d, h), (-1 === f && "removed" == j || f >= 0 && "applied" == j) && g.push(d));
            return g
        },
        Fb = function(b, c, e) {
            var f = function(c) {
                ...
                var g = Eb(b, e);
                if (null !== f && -1 !== a.inArray(f, g)) return [f];
                if (!c) return g;
    ...
    Xa("rows()", function(b, c) {
        ...
        return this.iterator("row", function(b, c, e) {
            ...
            for (l.splice(c, 1), f = 0, g = l.length; g > f; f++)
                if (j = l[f], k = j.anCells, null !== j.nTr && (j.nTr._DT_RowIndex = f), null !== k)
                    for (h = 0, i = k.length; i > h; h++) k[h]._DT_CellIndex.row = f;
            F(b.aiDisplayMaster, c), F(b.aiDisplay, c), F(a[e], c, !1), Oa(b);
        ...
        var c = this.iterator("table", function(a) {
                var c, d, e, f = [];
                for (d = 0, e = b.length; e > d; d++) c = b[d], c.nodeName && "TR" === c.nodeName.toUpperCase() ? f.push(v(a, c)[0]) : f.push(u(a, c));
                return f
            }, 1),
            d = this.rows(-1);
    ...
    var Gb = function(b, c, d, e) {
            var f = [],
                g = function(c, d) {
                    if (a.isArray(c) || c instanceof a)
                        for (var e = 0, h = c.length; h > e; e++) g(c[e], d);
        ...
        Jb = function(a) {
            var b = new Wa(a),
                ...
                f = "destroy" + c,
                g = a.aoData;
            b.off(d + " " + e + " " + f), kb(g, "_details").length > 0 && (b.on(d, function(c, d) {
                a === d && b.rows({
                    "page": "current"
                ...
                if (a === d)
                    for (var e = 0, f = g.length; f > e; e++) g[e]._details && Hb(b, e)
            }))
        },
        Kb = "",
        Lb = Kb + "row().child",
    ...
    var Nb = /^(.+):(name|visIdx|visible)$/,
        ...
        Qb = function(b, c, e, f) {
            var g, h, i, j, k = b.aoColumns,
                l = k[c],
                m = b.aoData;
            if (e === d) return l.bVisible;
            if (l.bVisible !== e) {
                if (e) {
                    var o = a.inArray(!0, kb(k, "bVisible"), c + 1);
                    for (h = 0, i = m.length; i > h; h++) j = m[h].nTr, g = m[h].anCells, j && j.insertBefore(g[c], g[o] || null)
                } else a(kb(b.aoData, "anCells", c)).detach();
                l.bVisible = e, L(b, b.aoHeader), L(b, b.aoFooter), (f === d || f) && n(b), Na(b, null, "column-visibility", [b, c, e, f]), Fa(b)
            }
        };
    ...
    Xa("cells()", function(b, c, e) {
            ...
            return b === d ? 0 !== e.length ? e[0].aaSorting : d : ("number" == typeof b ? b = [
                [b, c]
            ] : a.isArray(b[0]) || (b = Array.prototype.slice.call(arguments)), this.iterator("table", function(a) {
                a.aaSorting = b.slice()
            }))
            ...
            "throttle": ta,
            "escapeRegex": aa
        }, Ua.camelToHungarian = f, Xa("$()", function(b, c) {
            ...
            return c = c || !1, this.iterator("table", function(d) {
                ...
                var q = a.inArray(d, Ua.settings); - 1 !== q && Ua.settings.splice(q, 1)
            })
        ...
        }), Ua.version = "1.10.11", Ua.settings = [], Ua.models = {}, Ua.models.oSearch = {
            "bCaseInsensitive": !0,
            "sSearch": "",
            "bRegex": !1,
            "bSmart": !0
    ...
    a.extend(Sb, {
                            ...
                            if (r = d[f], a.isArray(r)) {
                                ...
                                switch (i = null, j = "", r) {
                                    ...
                                    case "previous":
                                        ...
                                        break;
                                    case "next":
                                        i = m.sNext, j = r + (h - 1 > g ? "" : " " + l.sPageButtonDisabled);
                                        break;
                                    case "last":
                                        i = m.sLast, j = r + (h - 1 > g ? "" : " " + l.sPageButtonDisabled);
                                        break;
                                    default:
        ...
        if (a && !(a instanceof Date) && (!ab.test(a) || !bb.test(a))) return null;
        var c = Date.parse(a);
        return null !== c && !isNaN(c) || eb(a) ? "date" : null
    }, function(a, b) {
        var c = b.oLanguage.sDecimal;
