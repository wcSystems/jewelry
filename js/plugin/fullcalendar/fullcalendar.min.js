! function(t, e) {
    if ("object" == typeof exports && "object" == typeof module) module.exports = e(require("jquery"), require("moment"));
    else if ("function" == typeof define && define.amd) define(["jquery", "moment"], e);
    else {
        var n = "object" == typeof exports ? e(require("jquery"), require("moment")) : e(t.jQuery, t.moment);
    ...
    return function(t) {
        ...
        function A(t, n) {
            var r, i, o;
            for (r = 0; r < e.unitsDesc.length && (i = e.unitsDesc[r], !((o = G(i, t, n)) >= 1 && ut(o))); r++);
            return i
        }
        ...
        e.mergeProps = Q, e.copyOwnProps = X, e.hasOwnProp = $, e.applyAll = K, e.removeMatching = J, e.removeExact = tt, e.isArraysEqual = et, e.firstDefined = nt, e.htmlEscape = rt, e.stripHtmlEntities = it, e.cssToStr = ot, e.attrsToStr = st, e.capitaliseFirstLetter = at, e.compareNumbers = lt, e.isInt = ut, e.proxy = dt, e.debounce = ct
    }, function(t, n) {
        t.exports = e
    }, function(t, e, n) {
        function r(t, e) {
        ...
        var i = n(3),
            ...
            s = function() {
                ...
                return t.prototype.intersect = function(e) {
                    var n = this.startMs,
                        r = this.endMs,
                        i = null;
        ...
        var r = n(0),
            ...
            l = function(t) {
                ...
                return r.__extends(e, t), e.prototype.fetch = function(t, e, n) {}, e.prototype.removeEventDefsById = function(t) {}, e.prototype.removeAllEventDefs = function() {}, e.prototype.getPrimitive = function(t) {}, e.prototype.parseEventDefs = function(t) {
                    var e, n, r = [];
                    ...
                    return e && (t = e(t)), n && (t = n(t)), a.default.parse(t, this)
                ...
                }, e.defineStandardProps = o.default.defineStandardProps, e.copyVerbatimStandardProps = o.default.copyVerbatimStandardProps, e.uuid = 0, e
            }(s.default);
        ...
        var r = n(1),
            ...
            u = function() {
                ...
                return t.prototype.bind = function() {
                    ...
                    var t = this,
                        e = i.default.touchMouseIgnoreWait;
        ...
        var r = n(4),
            i = function() {
                ...
                return t.prototype.isAllDay = function() {
        ...
        function r(t, e, n) {
            var r = p[t] || (p[t] = {});
            r.isRTL = n.isRTL, r.weekNumberTitle = n.weekHeader, a.each(h, function(t, e) {
                r[t] = e(n)
            });
            var i = a.datepicker;
            i && (i.regional[e] = i.regional[t] = n, i.regional.en = i.regional[""], i.setDefaults(n))
        }

        function i(t, e) {
            var n, r;
            n = p[t] || (p[t] = {}), e && (n = p[t] = d.mergeOptions([n, e])), r = s(t), a.each(f, function(t, e) {
                null == n[t] && (n[t] = e(r, n))
        ...
        var a = n(1),
            ...
            c = n(2),
            p = u.default.locales;
        e.localeOptionHash = p, e.datepickerLocale = r, e.locale = i;
        var h = {
        ...
        e.populateInstanceComputableOptions = o, e.getMomentLocaleData = s, i("en", d.englishDefaults)
    }, function(t, e, n) {
        Object.defineProperty(e, "__esModule", {
            value: !0
        });
        ...
        var r = n(1),
            ...
            o = function() {
                ...
                return t.prototype.clone = function() {
                    ...
                    return e._id = this.uid, e.source = this.source, e.className = this.className.slice(), e.allDay = this.isAllDay(),
                        null != this.rawId && (e.id = this.rawId), t.copyVerbatimStandardProps(this, e), e
                    ...
                    return "_fc" + t.uuid++
                }, t.defineStandardProps = i.default.defineStandardProps, t.copyVerbatimStandardProps = i.default.copyVerbatimStandardProps, t.uuid = 0, t
            }();
        ...
        var r = n(2),
            ...
            l = function() {
                function t() {}
                return t.prototype.mutateSingle = function(t) {
                    var e;
            ...
            l = function(t) {
                ...
                return r.__extends(e, t), e.prototype.setElement = function(e) {
                    ...
                    this.el.on(e, function(t) {
                        if (!i(t.target).is(r.segSelector + "," + r.segSelector + " *,.fc-more,a[data-goto]")) return n.call(r, t)
                    })
                    ...
                    t.on(e, this.segSelector, function(t) {
                        var e = i(t.currentTarget).data("fc-seg");
                        if (e && !r.shouldIgnoreEventPointing()) return n.call(r, e, t)
                    })
        ...
        var r = n(0),
            ...
            p = function(t) {
                ...
                return r.__extends(e, t), e.prototype._getView = function() {
                    ...
                    var t, e, n, r = this;
                    this.opt("nowIndicator") && (t = this.getNowIndicatorUnit()) && (e = s.proxy(this, "updateNowIndicator"), this.initialNowDate = this.calendar.getNow(), this.initialNowQueriedMs = +new Date, n = this.initialNowDate.clone().startOf(t).add(1, t) - this.initialNowDate, this.nowIndicatorTimeoutID = setTimeout(function() {
                    ...
                    var i = this.calendar.eventManager,
                        s = i.mutateEventsWithId(t.def.id, e, this.calendar),
                        a = e.dateMutation;
                    ...
                    var i = this.calendar.eventManager,
                        o = i.mutateEventsWithId(t.def.id, e, this.calendar);
                    t.dateProfile = e.dateMutation.buildNewDateProfile(t.dateProfile, this.calendar), this.triggerEventResize(t, e.dateMutation.endDelta, o, n, r)
            ...
            o = function() {
                ...
                return t.prototype.opt = function(t) {
                    ...
                    var n = t.footprint.componentFootprint,
                        r = n.unzonedRange,
                        o = e.footprint.componentFootprint,
                        s = o.unzonedRange;
                    return r.startMs - s.startMs || s.endMs - s.startMs - (r.endMs - r.startMs) || o.isAllDay - n.isAllDay || i.compareByFieldSpecs(t.footprint.eventDef, e.footprint.eventDef, this.view.eventOrderSpecs)
                }, t
            }();
        e.default = o
    }, function(t, e, n) {
        ...
        var r = n(0),
            ...
            a = function(t) {
                ...
                return r.__extends(e, t), e.prototype.constructed = function() {}, e.prototype.applyGlobalWatchers = function() {
        ...
        var r = n(2),
            ...
            o = function() {
                ...
                return t.prototype.buildNewDateProfile = function(t, e) {
                    var n = t.start.clone(),
                        r = null,
                        o = !1;
        ...
        e.default = {
            ...
            getThemeClass: function(t) {
                return t ? !0 === t ? i.default : this.themeClassHash[t] : r.default
            }
        }
    }, function(t, e, n) {
        function r(t) {
        ...
        var r = n(1),
            ...
            o = function() {
                ...
                return t.prototype.build = function() {
                    ...
                    var t;
                    return this.els.length > 0 && (t = i.getScrollParent(this.els.eq(0)), !t.is(document)) ? i.getClientRect(t) : null
            ...
            s = function(t) {
                ...
                return r.__extends(e, t), e.prototype.updateDayTable = function() {
                    ...
                    var r = this,
                        ...
                        l = i.htmlEscape(t.format(r.colHeadFormat));
                    return 1 === r.rowCnt ? a = a.concat(r.getDayClasses(t, !0)) : a.push("fc-" + i.dayIDs[t.day()]), '<th class="' + a.join(" ") + '"' + (1 === (s && r.rowCnt) ? ' data-date="' + t.format("YYYY-MM-DD") + '"' : "") + (e > 1 ? ' colspan="' + e + '"' : "") + (n ? " " + n : "") + ">" + (s ? o.buildGotoAnchorHtml({
                        date: t,
                        forceOff: r.rowCnt > 1 || 1 === r.colCnt
                    }, l) : l) + "</th>"
            ...
            I = function() {
                ...
                return t.prototype.constructed = function() {}, t.prototype.getView = function() {
                    ...
                    e.addClass("fc"), e.on("click.fc", "a[data-goto]", function(e) {
                        ...
                        var r = M.default.getThemeClass(n.themeSystem || n.theme),
                        ...
                        t.businessHourGenerator = new D.default(e.businessHours, t), t.view && t.view.set("businessHourGenerator", t.businessHourGenerator)
                    }, function() {
                    ...
                    this.header = new c.default(this, this.computeHeaderOptions()), this.footer = new c.default(this, this.computeFooterOptions()), this.toolbarsManager = new a.default([this.header, this.footer])
                    ...
                    return n = e ? this.moment(e).stripZone() : r.hasTime() ? r.clone().add(this.defaultTimedEventDuration) : r.clone().add(this.defaultAllDayEventDuration), new m.default(new y.default(r, n), !r.hasTime())
                    ...
                    for (var t = [], e = 0; e < arguments.length; e++) t[e] = arguments[e];
                    var n;
                    return "local" === this.opt("timezone") ? (n = v.default.apply(null, t), n.hasTime() && n.local()) : n = "UTC" === this.opt("timezone") ? v.default.utc.apply(null, t) : v.default.parseZone.apply(null, t), this.localizeMoment(n), n
                    ...
                    var e, n = this.moment(t.toArray()),
                        r = t.time() - n.time();
                    return r && (e = n.clone().add(r), t.time() - e.time() == 0 && (n = e)), n
                }, t.prototype.footprintToDateProfile = function(t, e) {
                    var n, r = v.default.utc(t.unzonedRange.startMs);
                    return e || (n = v.default.utc(t.unzonedRange.endMs)), t.isAllDay ? (r.stripTime(), n && n.stripTime()) : (r = this.applyTimezone(r), n && (n = this.applyTimezone(n))), new b.default(r, n, this)
                    ...
                    r instanceof C.default && (e = r.buildInstance(), n = R.default.createFromRawProps(e, t, null), this.eventManager.mutateEventsWithId(r.id, n))
        ...
        var r = n(0),
            ...
            s = function(t) {
                ...
                return r.__extends(e, t), e.prototype.applyProps = function(t) {
        ...
        var r = n(0),
            ...
            a = function(t) {
                ...
                return r.__extends(e, t), e.prototype.fetch = function(t, e, n) {
                    var r = this;
        ...
        var r = n(0),
            ...
            l = function(t) {
                ...
                return r.__extends(e, t), e.prototype.fetch = function(t, n, r) {
                    var a = this,
                        l = this.ajaxSettings,
                        u = l.success,
                        d = l.error,
            ...
            o = function(t) {
                ...
                return r.__extends(e, t), e.prototype.queue = function(t, e, n) {
                    ...
                    if (t.namespace && "destroy" === t.type)
                        for (e = r.length - 1; e >= 0; e--) switch (n = r[e], n.type) {
                            case "init":
                                i = !1;
                            case "add":
                            case "remove":
            ...
            s = function() {
                ...
                return t.prototype.opt = function(t) {
                    ...
                    var r, i = this.opt("dateAlignment"),
                        s = 0,
                        a = t.clone();
                    i && a.startOf(i), a.startOf("day"), a = this._view.skipHiddenDays(a, e), r = a.clone();
                    do {
        ...
        function r(t) {
            var e, n, r, i, l = a.default.dataAttrPrefix;
        ...
        e.default = v, d.default.mixInto(v)
    }, function(t, e, n) {
        Object.defineProperty(e, "__esModule", {
            value: !0
        });
        ...
        function r(t) {
            return function(t) {
                ...
                return s.__extends(e, t), e.prototype.renderHeadIntroHtml = function() {
                    var t, e = this.view,
                        n = e.calendar,
        ...
        function i(t) {
            return function(t) {
                ...
                return s.__extends(e, t), e.prototype.renderBgIntroHtml = function() {
                    var t = this.view;
        ...
        var s = n(0),
            ...
            f = function(t) {
                ...
                return s.__extends(e, t), e.prototype.instantiateTimeGrid = function() {
                        return new(r(this.timeGridClass))(this)
        ...
        e.default = f, f.prototype.timeGridClass = p.default, f.prototype.dayGridClass = h.default
    }, function(t, e, n) {
        Object.defineProperty(e, "__esModule", {
            value: !0
        });
        ...
        var r = n(0),
            ...
            u = function(t) {
                ...
                return r.__extends(e, t), e.prototype.buildRenderRange = function(e, n, r) {
                    var i, o = t.prototype.buildRenderRange.call(this, e, n, r),
                        a = this.msToUtcMoment(o.startMs, r),
                        l = this.msToUtcMoment(o.endMs, r);
                    return this.opt("fixedWeekCount") && (i = Math.ceil(l.diff(a, "weeks", !0)), l.add(6 - i, "weeks")), new s.default(a, l)
                }, e
            }(l.default),
            d = function(t) {
                function e() {
        ...
        e.default = d, d.prototype.dateProfileGeneratorClass = u
    }, function(t, e, n) {
        Object.defineProperty(e, "__esModule", {
            value: !0
        });
        ...
        var r = n(48);
        e.Calendar = r.default;
        var i = n(19);
        r.default.defaults = i.globalDefaults, r.default.englishDefaults = i.englishDefaults, r.default.rtlDefaults = i.rtlDefaults;
        var o = n(2);
        ...
        var s = n(37);
        e.formatDate = s.formatDate, e.formatRange = s.formatRange, e.queryMostGranularFormatUnit = s.queryMostGranularFormatUnit;
        var a = n(20);
        e.datepickerLocale = a.datepickerLocale, e.locale = a.locale;
        var l = n(9);
        e.moment = l.default;
        var u = n(8);
        e.EmitterMixin = u.default;
        var d = n(6);
        e.ListenerMixin = d.default;
        var c = n(32);
        e.Model = c.default;
        var p = n(49);
        e.Constraints = p.default;
        var h = n(4);
        ...
        var v = n(22);
        e.EventDef = v.default;
        var y = n(26);
        e.EventDefMutation = y.default;
        var m = n(25);
        e.EventSourceParser = m.default;
        var b = n(5);
        e.EventSource = b.default;
        var w = n(36);
        e.ThemeRegistry = w.default;
        var D = n(17);
        e.EventInstanceGroup = D.default;
        var E = n(34);
        e.ArrayEventSource = E.default;
        var S = n(57);
        e.FuncEventSource = S.default;
        var C = n(58);
        e.JsonFeedEventSource = C.default;
        var R = n(24);
        e.EventFootprint = R.default;
        var T = n(21);
        e.Class = T.default;
        var M = n(12);
        e.Mixin = M.default;
        var I = n(38);
        e.CoordCache = I.default;
        var P = n(39);
        e.DragListener = P.default;
        var H = n(16);
        e.Promise = H.default;
        var _ = n(59);
        e.TaskQueue = _.default;
        var x = n(60);
        e.RenderQueue = x.default;
        var F = n(28);
        ...
        var B = n(29);
        e.InteractiveDateComponent = B.default;
        var k = n(30);
        e.View = k.default;
        var A = n(40);
                    ...
                    return u && r.each(u.split(" "), function(t, s) {
                        ...
                        r.each(s.split(","), function(t, s) {
                            ...
                            "title" == s ? (h = h.add(r("<h2>&nbsp;</h2>")), f = !1) : ((l = d[s]) ? (g = function(t) {
                                ...
                                n[s]()
                            }, (y = c[s]) || (v = o.getIconClass(s)) || (y = p[s])), g && (b = ["fc-" + s + "-button", o.getClass("button"), o.getClass("stateDefault")], y ? m = i.htmlEscape(y) : v && (m = "<span class='" + v + "'></span>"), w = r('<button type="button" class="' + b.join(" ") + '">' + m + "</button>").click(function(t) {
            ...
            u = function() {
                ...
                return t.prototype.clearCache = function() {
                    ...
                    if (-1 != i.inArray(t, s.unitsDesc))
                        for (e = this._calendar.header.getViewsWithButtons(), i.each(o.default.views, function(t) {
                                e.push(t)
                            }), n = 0; n < e.length; n++)
                            if ((r = this.getViewSpec(e[n])) && r.singleUnit == t) return r
                }, t.prototype.buildViewSpec = function(t) {
                    for (var e, n, i, l, u, d = this.optionsManager.overrides.views || {}, c = [], p = [], h = [], f = t; f;) e = o.default.views[f], n = d[f], f = null, "function" == typeof e && (e = {
                        class: e
            ...
            s = function(t) {
                ...
                return r.__extends(e, t), e.prototype.attachSegEls = function(t, e) {
                    ...
                    var n, r, o, s = this.component.colCnt,
                        a = e.leftCol,
                        l = e.rightCol + 1;
                    return n = "businessHours" === t ? "bgevent" : t.toLowerCase(), r = i('<div class="fc-' + n + '-skeleton"><table><tr/></table></div>'), o = r.find("tr"), a > 0 && o.append('<td colspan="' + a + '"/>'), o.append(e.el.attr("colspan", l - a)), l < s && o.append('<td colspan="' + (s - l) + '"/>'), this.component.bookendCells(o), r
                }, e
            }(o.default);
        e.default = s
    }, function(t, e, n) {
        ...
        var r = n(36),
            ...
            o = n(56),
            s = n(94);
        r.default.register("standard", i.default), r.default.register("jquery-ui", o.default), r.default.register("bootstrap3", s.default)
    }, function(t, e, n) {
        Object.defineProperty(e, "__esModule", {
            value: !0
        });
