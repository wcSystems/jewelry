						...
						<div class="jarviswidget jarviswidget-color-darken" id="wid-id-1" data-widget-colorbutton="false" data-widget-deletebutton="false" data-widget-editbutton="false" data-widget-custombutton="false">
							...
							<div class="content">
								...
								<div class="widget-body no-padding">
									<form id="nuevo-form" onSubmit="event.preventDefault();" class="smart-form" action="php/caja/egreso/egreso.php" method="post">
												...
												<section class="col col-6">
													<label class="input">
														...
														<select onchange="objeto['CONCEPTO'] = $(this).val()" name="concepto" style="text-align-last: center;" class="input-sm col-12 nocaret">
															...
															<option value="7">Retiro Capital</option>
														</select>
													</label>
												</section>
											</section>
										...
										<footer style="border-bottom:1px solid rgba(0,0,0,.1)">
											<section class="col col-12 no-margin">
												<button class="btn btn-success right" type="submit">Egresar</button>
											</section>
										</footer>
									</form>
...
<script>
	...
	function elim(id){
		$.ajax({
			url:"php/caja/egreso/elim.php",
			type:"POST",
			data:{"DATO":id},
			success:function(resp){
				//resp = JSON.parse(resp);
				alerta('success','Egreso eliminado');
				buscar();
			}
		})
